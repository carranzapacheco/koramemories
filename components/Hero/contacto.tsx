...
export const Contacto: React.FC = () => {
  return (
    <section className="w-full bg-[#F5F1EC] py-20 px-6 flex flex-col items-center text-center">
      
      {/* Título */}
      <h2 className="max-w-4xl text-[#2E2E2E] text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-6 leading-tight">
        Mantén cerca a quienes siempre estarán en tu corazón
      </h2>

      {/* Descripción */}
      <p className="max-w-2xl text-[#1f1f1f] text-lg md:text-xl mb-10 leading-relaxed">
        Crea un tributo lleno de recuerdos, fotos, videos y mensajes.  
        Cada instante compartido se convierte en un lazo que nunca se rompe.
      </p>
